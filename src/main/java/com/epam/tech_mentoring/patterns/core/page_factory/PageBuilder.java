...
import com.epam.tech_mentoring.patterns.core.page_factory.decorator.CustomFieldDecoratorNew;
...
public class PageBuilder {
    public static  <T extends BasePage> T build (Class<T> clazz) {
        ...
        FieldDecorator decorator = new CustomFieldDecoratorNew(factory);
